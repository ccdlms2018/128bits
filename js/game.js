...
Pilot.prototype.updateLogo = function () {
    var logo = this.logo;
...
var AirPlane = function () {
    ...
    var texture = loader.load("./img/128-01.jpg");

    var geomLogo = new THREE.BoxGeometry(150, 50, 2, 1, 1, 1);
    var matLogo = new THREE.MeshPhongMaterial({color: Colors.white, shading: THREE.FlatShading});
    matLogo.map = texture;
    this.logo = new THREE.Mesh(geomLogo, matLogo);
    this.logo.position.x = -150;
